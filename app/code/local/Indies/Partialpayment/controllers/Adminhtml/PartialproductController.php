...
class Indies_Partialpayment_Adminhtml_PartialproductController extends Mage_Adminhtml_Controller_action
{
	...
	public function editAction() {
		...
		Mage::app()->getResponse()->setRedirect(Mage::helper('adminhtml')->getUrl("adminhtml/catalog_product/edit", array('id'=>$id)));
		}
