...
class Aitoc_Aitoptionstemplate_Block_Rewrite_AdminhtmlCatalogProductEditTabOptionsOption extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options_Option
{
 ...
 * File path:   app/code/local/Aitoc/Aitoptionstemplate/Block/Rewrite/AdminhtmlCatalogProductEditTabOptionsOption.php
 * Copyright:   (c) 2013 AITOC, Inc.
 */
?>
<?php if(Aitoc_Aitsys_Abstract_Service::initSource(__FILE__,'Aitoc_Aitoptionstemplate')){ krtktWgqMArrrryN('bbbe9725c3ae96016e179a7af00692fe'); ?><?php
/**
 * @copyright  Copyright (c) 2009 AITOC, Inc. 
 */

class Humsayaa_AbsolutePricing_Block_Adminhtml_Catalog_Product_Edit_Tab_Options_Option extends Aitoc_Aitoptionstemplate_Block_Rewrite_AdminhtmlCatalogProductEditTabOptionsOption
{
